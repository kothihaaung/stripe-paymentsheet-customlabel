...
extension PaymentSheetFormFactory {
    ...
    func makeBillingAddressSection(
        ...
        let section = AddressSectionElement(
            title: PaymentSheet.Configuration.customLables["Billing address"] ?? String.Localized.billing_address_lowercase,
            countries: countries,
            addressSpecProvider: addressSpecProvider,
            ...
            theme: theme,
            countryOrRegion: PaymentSheet.Configuration.customLables["Country or region"]
        )
