...
extension SavedPaymentOptionsViewController: PaymentOptionCellDelegate {
    func paymentOptionCellDidSelectRemove(
        ...
        let alert = UIAlertAction(
            title: PaymentSheet.Configuration.customLables["Remove"] ?? String.Localized.remove, style: .destructive
        ) { (_) in
        ...
        let cancel = UIAlertAction(
            title: PaymentSheet.Configuration.customLables["Cancel"] ?? String.Localized.cancel,
...
extension STPPaymentMethod {
    var removalMessage: (title: String, message: String) {
        ...
        case .card:
            ...
            let formattedMessage = PaymentSheet.Configuration.customLables["Remove %1$@ ending in %2$@"] ?? STPLocalizedString(
            ...
            return (
                title: PaymentSheet.Configuration.customLables["Remove Card"] ?? STPLocalizedString(
                    "Remove Card",
