...
class PaymentSheetViewController: UIViewController {
    ...
    private func updateUI(animated: Bool = true) {
        ...
        case .addingNew:
            ...
            if let headerText = PaymentSheet.Configuration.customLables["Add your payment information"] {
        ...
        case .selectingSaved:
            ...
            if let selectYourPayment = PaymentSheet.Configuration.customLables["Select your payment method"] {
                headerLabel.text =
...
extension PaymentSheetViewController: SavedPaymentOptionsViewControllerDelegate {
    ...
    func configureEditSavedPaymentMethodsButton() {
        if savedPaymentOptionsViewController.isRemovingPaymentMethods {
            navigationBar.additionalButton.setTitle(PaymentSheet.Configuration.customLables["Done"] ?? UIButton.doneButtonTitle, for: .normal)
            buyButton.update(state: .disabled)
        } else {
            buyButton.update(state: .enabled)
            navigationBar.additionalButton.setTitle(PaymentSheet.Configuration.customLables["Edit"] ?? UIButton.editButtonTitle, for: .normal)
        }
